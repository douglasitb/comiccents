...
$sql ="INSERT INTO usuario(NOME_USUARIO,EMAIL_USUARIO,SENHA_USUARIO,LOGRADOURO_USUARIO,BAIRRO_USUARIO,CIDADE_USUARIO, ESTADO_USUARIO,RG_USUARIO,CPF_USUARIO,SEXO_USUARIO,DATA_NASCIMENTO,TIPO_USUARIO,TELEFONE_USUARIO,CEP_USUARIO,NUMERO_USUARIO,COMPLEMENTO_USUARIO)
                   VALUES('$nome_usuario','$email_usuario','$senha_usuario','$logradouro_usuario','$bairro_usuario','$cidade_usuario','$estado_usuario','$rg_usuario','$cpf_usuario','$sexo_usuario','$data_nasc_usuario','$tipo_usuario','$telefone_usuario','$cep_usuario','$numero_usuario','$complemento_usuario')";
if(mysql_query($sql))
